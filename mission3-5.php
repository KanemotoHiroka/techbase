...
<body>
    <h4>使い方</h4>
    <p>
        投稿したい時:名前，コメント，パスワードを入力してsubmitボタンを押す。<br>
        削除したい時:1. 削除したい投稿の番号を選択 2. 削除したい投稿に用いたパスワードを入力 3. 削除ボタンを押す。<br>
        削除ができたら「投稿が削除されました」とでます。<br>
        編集したい時:1. 編集したい投稿の番号を選択 2. 編集したい投稿に用いたパスワードを入力 3. 編集ボタンを押す<br>
        編集モードでは，「編集が有効です」とでます。投稿時に用いるフォームに，編集したい投稿の内容が表示されます。<br>
        内容を編集した上で，submitボタンを押してください。<br>
        注意点:パスワードは変更できません！<br>
    </p>
    
    <h5>書くことがない時のテーマ:このメンバーでやってみたいこと</h5>
    <p>
        例:<br>
        自己紹介でhtml使えなかったからもう一回時間とってやりたい！<br>
        もくもく会を毎日開きたい！<br>
        せっかくだからタメでしゃべりたい！<br>
    </p>
    <?php
    ...
    <form method="POST" action="" id="info">      
        ...
        パスワードを入力:<input type="text" name="password" value=<?php if(!empty($edit_password)){echo $edit_password;}else{echo "password";}?>><br>
        <input type="hidden" name="flag_edit" value=<?php echo $edit_number?>><br>
        <input type="submit" name="submit" value="submit"><br>
    </form>
<hr>
    <form method="POST" action="" id="delete">   
        削除したい投稿のパスワードを入力:<input type="text" name="password" value="password"><br>
        削除する投稿番号:<input type="number" name="delete_number" value="1"><br>
        <input type="submit" name="delete" value="削除する"><br>
    </form>
<hr>
    <form method="POST" action="" id="edit">   
        編集したい投稿のパスワードを入力:<input type="text" name="password" value="password"><br>
